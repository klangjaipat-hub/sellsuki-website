  ...
  <div>
    ...
    <div class="keen-slider" ref="slider">
      <div class="keen-slider__slide">
        <div @click="openModal(0)" class="card card-port pb-3">
          <div class="card-body pb-4">
            <h5 class="text-s-36">
              เพิ่มยอดขายกว่า
              <span class="theme-text-main font-bd"
                >1,000 ล้านบาท หรือเติบโต 100%<br />
                ภายใน 1 ปี</span
              >
            </h5>
          </div>
      ...
      <div class="keen-slider__slide">
        <div @click="openModal(1)" class="card card-port pb-3">
          <div class="card-body pb-4">
            <h5 class="text-s-36">
              กระจายช่องทางการขาย
              <span class="theme-text-main font-bd"
                >โดยมีพันธมิตรร้านค้ามากกว่า<br> 10,000 ร้านค้า</span
              >
            </h5>
          </div>
          <img
      ...
      <div class="keen-slider__slide">
        <div @click="openModal(2)" class="card card-port pb-3">
          <div class="card-body pb-4">
            <h5 class="text-s-36">
              ทำยอดวิวบน TikTok
              <span class="theme-text-main font-bd"
                > มากกว่า 500 ล้านวิว</span
              >
            </h5>
          </div>
          <img
  ...
  data() {
    return {
      ...
      images: [
        ...
        {
          id: 1,
          url: "https://sellsuki-web-storage-production.s3.ap-southeast-1.amazonaws.com/1_1000_039ffa4215.png",
        ...
        {
          id: 3,
          url: "https://sellsuki-web-storage-production.s3.ap-southeast-1.amazonaws.com/2_tiktok_8a1c2e0dff.png",
          title: "ทำยอดวิวบน TikTok มากกว่า 500 ล้านวิว",
          discretion: "Social  Boom ใช้สื่อเป็น ใช้คนเป็น เพิ่มการมองเห็น ถล่มทลาย ทำยอดวิวบน TikTok มากกว่า 500 ล้านวิว"
        }
      ],
      showModal: false,
