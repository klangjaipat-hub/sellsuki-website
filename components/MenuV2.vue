...
<div class="font-md">
  ...
  <nav v-if="statusMenu == false && blogname != ''" class="navbar navbar-expand-lg fixed-top d-none d-md-block" style="z-index: 9999;">
    <div class="container">
      <div class="ml-2">
  ...
  <nav v-else class="nav-custom fixed-top d-none d-md-block animate__animated animate__fadeInDown" style="z-index: 999;">
    <div class="row">
      <div class="col-3 col-xl-2 ps-5">
        <a class="navbar-brand" href="/blog">
          <img src="../assets/v2/Logoblog.svg" alt="sellsuki-logo" loading="lazy" class="d-inline-block align-text-top cover-img">
        </a>
      </div>
      <div class="col-6 col-xl-8 text-center m-auto">
        <p class="text-s-36 font-md text-limit-1 ps-2 pe-2 ps-xl-5 pe-xl-5 mb-0">{{blogname}}</p>
      </div>
      <div class="col-3 col-xl-2 pe-5 text-end">
...
<script>
import NavMobileV2 from '@/components/NavMobileV2'
